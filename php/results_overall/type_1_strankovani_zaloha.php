<?php
		...
		if($sth1->rowCount()){
		    ...
		    $str .= '<li>';
		    $str .= '<li><a id="blaa" href="#">1-100</a></li>';
		    $str .= '<li><a href="#">101-200</a></li>';
		    $str .= '</ul>';
		    $str .= '</nav>';
			...
			if($sth3->rowCount()){
			    ...
			    $str .= '<tr><td class="text-center"><b>'.$poradi.'</b></td><td class="text-center">'.$data1->ids.'</td><td>'.$dbdata3->jmeno.'</td><td class="text-center">'.$dbdata3->rocnik.'</td><td>'.$dbdata3->nazev_tymu.'</td><td class="text-center">'.$dbdata3->stat.'</td><td class="text-center">'.$dbdata3->nazev_kategorie.'</td><td class="text-center"><b>'.$data1->rank_category.'</b></td>';
