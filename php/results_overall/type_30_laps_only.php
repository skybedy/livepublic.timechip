<?php
    ...
    $sql1 = "SELECT "
	    ...
	    . "WHERE "
	      . "race_time > 0 AND "
	      . "$this->sqlvysledky.lap_count = :time_order AND " //tady musí být místo time order lap_count
	...
	$str .= '<thead><tr class="header"><th class="text-center">#</th><th class="text-center">St.č</th><th>Jméno</th><th class="text-center">Stát</th><th>Tým</th><th class="text-center">Kat</th><th  class="text-center">Poř</th><th class="text-center">Čas</th><th class="text-center">Odstup</th>';
	$str .= '</tr>';
	$str .= '</thead><tbody>';
	$poradi = 1;
