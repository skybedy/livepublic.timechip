<?php
		...
		if($sth1->rowCount()){
			...
			if($sth3->rowCount()){
			    ...
			    $str .= '<tr><td class="text-center"><b>'.$poradi.'</b></td><td class="text-center">'.$data1->ids_alias.'</td><td>'.$dbdata3->jmeno.'</td><td class="text-center">'.$dbdata3->rocnik.'</td><td>'.$this->NahrazkaPomlcky($dbdata3->nazev_tymu).'</td><td class="text-center">'.$dbdata3->stat.'</td>';
                            $str .='<td class="text-center">'.$dbdata3->nazev_kategorie.'</td><td class="text-center"><b>'.$data1->rank_category.'</b></td><td class="text-center">'.$dbdata3->pohlavi.'</td><td class="text-center"><b>'.$data1->rank_gender.'</b></td>';
