<?php
		...
		if($sth1->rowCount()){
		    ...
		    $str .= '<th class="text-center">Pen</th></tr></thead><tbody>';
		    $poradi = 1;
		    if(isset($_GET['limit_od'])){
			...
			$sql3 = "SELECT CONCAT_WS(' ',$this->sqlosoby.prijmeni,$this->sqlosoby.jmeno) AS jmeno,$this->sqlosoby.rocnik,$this->sqlosoby.psc AS stat,$this->sqlosoby.pohlavi,$this->sqlkategorie.kod_k AS nazev_kategorie,tymy.nazev_tymu,$this->sqlzavod.penalizace FROM $this->sqlzavod,$this->sqlosoby,$this->sqlkategorie,tymy WHERE $this->sqlzavod.ids = :ids AND $this->sqlzavod.ido = osoby.ido AND $this->sqlzavod.id_tymu = tymy.id_tymu AND $this->sqlzavod.id_kategorie = $this->sqlkategorie.id_kategorie";
			...
			if($sth3->rowCount()){
			   ...
			   // $str .= '<tr><td class="text-center"><b>'.$poradi.'</b></td><td class="text-center">'.$data1->ids_alias.'</td><td>'.$dbdata3->jmeno.'</td><td class="text-center">'.$dbdata3->rocnik.'</td><td>'.$dbdata3->nazev_tymu.'</td><td class="text-center">'.$dbdata3->stat.'</td><td class="text-center">'.$dbdata3->nazev_kategorie.'</td><td class="text-center"><b>'.$data1->rank_category.'</b></td>';
			    $str .= '<tr><td class="text-center"><b>'.$poradi.'</b></td><td class="text-center">'.$data1->ids_alias.'</td><td>'.$dbdata3->jmeno.'</td><td class="text-center"></td><td>'.$dbdata3->nazev_tymu.'</td><td class="text-center">'.$dbdata3->stat.'</td><td class="text-center">'.$dbdata3->nazev_kategorie.'</td><td class="text-center"><b>'.$data1->rank_category.'</b></td>';
