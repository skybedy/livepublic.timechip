<?php  
    /* 
     * CROSS Country Open, oproti hobby navíc motorky
     */
	...
	$str .= '<thead><tr class="header"><th class="text-center">#</th><th class="text-center">St.č</th><th>Jméno</th><th class="text-center">Tým</th><th class="text-center">Stát</th><th>Kategorie</th><th class="text-center">Značka</th><th class="text-center">Čas</th><th class="text-center">Kolo</th><th class="text-center">Odstup</th><th class="text-center">Km/h</th><th class="text-center">Nejlepší čas</th><th class="text-center">Body</th>';
	$str .= '</tr></thead><tbody>';
	$poradi = 1;
