<?php
	    /*
	     * Pro Okin, bez veku, statu a oddilu
	     * 
	     */
		...
		if($sth1->rowCount()){
		    ...
		    $str .= '<thead><tr class="header"><th class="text-center">Poř</th><th class="text-center">St.č</th><th class="text-left">Jméno</th>';
                    $str .= '<th class="text-center">Kat</th> <th class="text-center">Poř</th>';
			...
			if($sth3->rowCount()){
			    ...
			    $str .= '<tr><td class="text-center"><b>'.$poradi.'</b></td><td class="text-center">'.$data1->ids_alias.'</td><td>'.$dbdata3->jmeno.'</td>';
                            $str .='<td class="text-center">'.$dbdata3->nazev_kategorie.'</td><td class="text-center"><b>'.$data1->rank_category.'</b></td>';
