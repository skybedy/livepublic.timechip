<?php
    /*
     * cross country hobby týmy bez etap
     */
		    ...
		    while($dbdata2 = $sth2->fetchObject()){ //2.cyklus
			    ...
			    */
				...
				while($dbdata3 = $sth3->fetchObject()){
					...
					$str .= '<td rowspan="'.$pocet_clenu.'" class="text-center"><a onclick="detail_ids_cc_bez_etap('.$dbdata2->ids.','.$this->race_id.','.$this->race_year.')" href="'.$hash_url.'vysledky">'.$dbdata2->ids.'</a></td>';
