<?php
	...
	if($sth->rowCount()){
	    $str .= '<table class="table table-bordered table-hove noborder table_vysledky"  id="table2excel">';
	    $k = 1;
		...
		if($sth1->rowCount()){
		    ...
		    $str .= '<tr class="header"><th class="text-center">#</th><th class="text-center">St.č</th><th>Tým</th><th>Členové týmu</th><th class="text-center">Ročník</th><th class="text-center">St.č</th><th class="text-center">Kola</th><th class="text-center">Km</th><th class="text-center">Celkový čas</th><th class="text-center">Odstup</th></tr>';
		    $poradi = 1;
			...
			while($dbdata3 = $sth3->fetchObject()){
				...
				/*
				 * uprava delana jen v kuchyni
				if($dbdata3->cip > 1000){
				    $cip = $dbdata3->cip + 3000;
				}
				 * */
