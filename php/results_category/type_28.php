<?php
	...
	if($sth->rowCount()){
		...
		if($sth1->rowCount()){
		    ...
		    $str .= '<tr class="header"><th class="text-center">Pos</th><th class="text-center">Bib</th><th>Name</th><th class="text-center">Birth Year</th><th class="text-center">Country</th><th class="text-center">Laps</th><th class="text-center">Total time</th><th class="text-center">Distance</th></tr>';
		    $poradi = 1;
