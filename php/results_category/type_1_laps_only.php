<?php
	...
	if($sth->rowCount()){
	    $str .= '<table class="table table-bordered table-hover table-striped noborder table_vysledky">';
	    $k = 1;
		...
		if($sth1->rowCount()){
		    ...
		    $str .= '<tr class="header"><th class="text-center">#</th><th class="text-center">St.č</th><th>Jméno</th><th class="text-center">Ročník</th><th class="text-center">Stát</th><th>Tým</th><th class="text-center">Čas</th><th class="text-center">Odstup</th></tr>';
		    $poradi = 1;
			...
			$str .= '<td class="text-center">'.$dbdata1->rocnik.'</b></td>';
	...
	if($sth->rowCount()){
	    ...
	    $str .= '<table class="table table-bordered table-striped table-hover table_vysledky">';
	    $sql1 = "SELECT "
		. "CONCAT_WS(' ',osoby.prijmeni,osoby.jmeno) AS jmeno,"
		. "osoby.rocnik,"
		. "osoby.psc AS stat,"
		...
		if($sth1->rowCount()){
		    $str .= '<thead><tr class="header"><th class="text-center">#</th><th class="text-center">St.č</th><th>Jméno</th><th class="text-center">Ročník</th><th class="text-center">Stát</th><th>Tým</th><th class="text-center">Čas</th><th class="text-center">Odstup</th></tr></thead><tbody>';
		    $poradi = 1;
		    while($dbdata1 = $sth1->fetchObject()){
			$str .= '<tr>';
			$str .= '<td class="text-center">'.$poradi.'</td>';
