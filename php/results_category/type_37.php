<?php
	...
	if($category_id == 'all'){
		...
		while($data = $sth->fetchObject()){
			...
			$str .= '<tr class="header"><th class="text-center">Poř</th><th class="text-center">St.č</th><th class="text-left">Jméno</th>';
			...
			while($data1 = $sth1->fetchObject()){
			    ...
			    $str .= '<tr><td class="text-center">'.$poradi.'</td><td class="text-center">'.$data1->ids_alias.'</td><td>'.$data1->jmeno.'</td>';
