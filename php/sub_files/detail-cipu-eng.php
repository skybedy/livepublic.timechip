...
<?php 
	...
	public function __construct() {
		...
		$str .= '<p>Lap count: <span class="color_red">'.$dbdata2->lap_count.'</span><br />';
		$str .= 'Total time: <span class="color_red">'.$dbdata2->total_lap_time.'</span><br />';
		$str .= '</p><br />';
	    }
		...
		$str .= '<thead><tr class="header"><th class="text-center">Lap</th><th class="text-center">Lap time</th><th class="text-center">#O</th><th class="text-center">#C</th><th class="text-center">Race time</th><th class="text-center">#O</th><th class="text-center">#C</th><th class="text-center">Day time</th></tr></thead><tbody>';
		$kolo = 1;
		...
		$str .= '</tbody></table>';
		$str .= "<p>#O - Lap overall rank<br>"; 
		$str .= "#C - Lap category rank</p>"; 
	    }
