<?php
		...
		$autoreading_results .= '<table class="table table-striped table-bordered table-hover xxl_radky">';
		$autoreading_results .= '<thead><tr class="xxl_header"><th rowspan="2" class="text-center">Poř</th><th rowspan="2" class="text-center">Stč</th><th rowspan="2">Jméno a příjmení</th><th rowspan="2" class="text-center">Čas</th><th colspan="2" class="text-center j_k">Kategorie</th></tr><tr class="xxl_header"><th class="text-center">Název</th><th class="text-center">Poř</th></tr></thead>';
		...
		if($sth3->rowCount()){
			...
			$autoreading_results .= '<tr><td class="text-center background_red">'.$data3->rank_overall.'</td><td class="text-center background_green">'.$data3->ids_alias.'</td><td class="align_left">'.$data3->cele_jmeno.'</td><td class="text-center color_blue">'.$data3->race_time.'</td><td class="text-center">'.$data3->nazev_kategorie.'</td><td class="text-center background_red">'.$data3->rank_category.'</td></tr>';
		    }
		}
