<?php
	    ...
	    $autoreading_results .= '<thead><tr class="vetsi_radky autoreading_header"><th class="text-center">St.č</th><th>Příjmení</th><th>Název týmu</th><th class="text-center">Kol</th><th class="text-center">Čas kola</th><th class="text-center">Celkový čas</th></tr></thead>';
		...
		$sql3 = "SELECT $this->sqlvysledky.cip,$this->sqlvysledky.lap_time,$this->sqlvysledky.race_time,$this->sqlvysledky.lap_count AS pocet_kol FROM $this->sqlvysledky WHERE $this->sqlvysledky.false_time IS NULL AND $this->sqlvysledky.reader = 'CIL' ORDER BY $this->sqlvysledky.race_time DESC LIMIT 0,8";
		
		//pouze na nolimit 12hod
